...
Enter the distance between node 1 and node 1: 
...
Enter the distance between node 4 and node 1: 
Enter the distance between node 4 and node 2: 
Enter the distance between node 4 and node 3: 
Enter the distance between node 4 and node 4: 
Enter the distance between node 4 and node 5: 
Enter the distance between node 5 and node 1: 
Enter the distance between node 5 and node 2: 
Enter the distance between node 5 and node 3: 
Enter the distance between node 5 and node 4: 
Enter the distance between node 5 and node 5: 
Optimal order of drilling: 
Optimal cost of drilling: 
